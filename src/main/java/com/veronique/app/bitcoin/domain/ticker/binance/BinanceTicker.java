...
public class BinanceTicker extends BaseTicker {
    ...
    public Ticker toTicker() {
        ...
        ticker.setBuy(this.getBidPrice());
        ticker.setLast(this.getLastPrice());
        ticker.setSell(this.getAskPrice());
        return ticker;
    }
}
